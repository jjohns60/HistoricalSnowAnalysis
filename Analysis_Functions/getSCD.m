...
% resolution) considering a folder of SCA files, considering an input date
% range. Requires an input folder to gridded snow cover data. Currently,
% only works for Tiff/GeoTiff files.
%
% INPUTS:
...
%   pixels (all others will be considered as no data)
